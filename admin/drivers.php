				...
				else
				{
					...
					if($result->num_rows > 0) {
						...
						while($row = $result->fetch_assoc()) {
							$id = $row["driver_id"];
							echo "<tr><td>" . $row["name"]. "</td><td>" . $row["v_type"]. "</td><td>" . $row["l_plate"]. "</td><td>" . $row["phone_no"]. "</td><td>" . $row["email"]. "</td><td>".$row["status"]."</td><td><a href='approve.php?id=$id' name='driverPosition'><button>Approve</button><a/></td></tr>";
							}	
						echo "</table>";
					} 
					else{
