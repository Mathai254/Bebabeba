...
public class BackgroundTask {
    ...
    public ArrayList<Contact> getList(final String v_type) throws JSONException {
            ...
            public void onResponse(JSONArray response) {
                ...
                while (count < response.length()) {
                    try {
                        ...
                        //sql lite
                        boolean isInserted = myDb.insertData(jsonObject.get("driver_id").toString(), jsonObject.get("latitude").toString(), jsonObject.get("longitude").toString());
                        if (isInserted) {
