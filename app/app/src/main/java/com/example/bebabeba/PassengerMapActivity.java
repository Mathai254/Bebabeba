...
/*    Intent intent = getIntent();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (googleServicesAvailable()) {
            ...
            BackgroundTask backgroundTask = new BackgroundTask(PassengerMapActivity.this);
            try {
...
*//*                            Intent intent = new Intent(PassengerMapActivity.this, DisplayList.class);
                        ...
                        builder.setMessage("Locate button clicked")
        ...
        if(location == null){
            ...
            if(res.getCount()==0){
                ...
                while(res.moveToNext()){
                    ...
                    //Toast.makeText(this, driver_id +" "+latitude+" "+longitude, Toast.LENGTH_LONG).show();

/*                    Double driverlat = new Double(latitude);
                    Double driverlng = new Double(longitude);*/
...
/*              buffer.append("ID: "+ res.getString(0)+"\n");
                buffer.append("Driver_ID: "+ res.getString(1)+"\n");
